...
$c_Lorg_scalajs_dom_package$.prototype.console__Lorg_scalajs_dom_raw_Console = (function() {
  return (((268435456 & this.bitmap$0$1) === 0) ? this.console$lzycompute__p1__Lorg_scalajs_dom_raw_Console() : this.console$1)
});
...
/** @constructor */
function $c_LCesiumApp$() {
  $c_O.call(this)
}
$c_LCesiumApp$.prototype = new $h_O();
$c_LCesiumApp$.prototype.constructor = $c_LCesiumApp$;
/** @constructor */
function $h_LCesiumApp$() {
  /*<skip>*/
}
$h_LCesiumApp$.prototype = $c_LCesiumApp$.prototype;
$c_LCesiumApp$.prototype.init___ = (function() {
  return this
});
$c_LCesiumApp$.prototype.main__V = (function() {
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("---> hello from scala CesiumApp\n");
  var viewer = new $g.Cesium.Viewer("cesiumContainer");
  var elem = new $g.Cesium.CzmlDataSource();
  var czmlStream = new $c_sr_ObjectRef().init___O(elem);
  viewer.dataSources.add(czmlStream.elem$1);
  var ws = new $g.WebSocket("ws://localhost:3210/");
  ws.onopen = (function(ws$1) {
    return (function(e$2) {
      $m_Lorg_scalajs_dom_package$().console__Lorg_scalajs_dom_raw_Console().log("-------> client request was sent...");
      ws$1.send("client ready")
    })
  })(ws);
  ws.onmessage = (function(czmlStream$1) {
    return (function(msg$2) {
      var msgData = $objectToString(msg$2.data);
      var jsx$1 = $m_Lorg_scalajs_dom_package$().console__Lorg_scalajs_dom_raw_Console();
      var s = ("-------> message received: " + msgData);
      jsx$1.log(s);
      var qual$1 = czmlStream$1.elem$1;
      var x$1 = $g.JSON.parse(msgData);
      return qual$1.process(x$1)
    })
  })(czmlStream);
  ws.onclose = (function(msg$2$1) {
    $m_Lorg_scalajs_dom_package$().console__Lorg_scalajs_dom_raw_Console().log("-------> Connection is closed...")
  })
});
$c_LCesiumApp$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_LCesiumApp$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_LCesiumApp$ = new $TypeData().initClass({
  LCesiumApp$: 0
}, false, "CesiumApp$", {
  LCesiumApp$: 1,
  O: 1,
...
$c_LCesiumApp$.prototype.$classData = $d_LCesiumApp$;
var $n_LCesiumApp$ = (void 0);
function $m_LCesiumApp$() {
  if ((!$n_LCesiumApp$)) {
    $n_LCesiumApp$ = new $c_LCesiumApp$().init___()
  };
  return $n_LCesiumApp$
}
$e.CesiumApp = $m_LCesiumApp$;
...
//# sourceMappingURL=cesiumscala-fastopt.js.map
